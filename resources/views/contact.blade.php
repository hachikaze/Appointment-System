                ...
                <div class="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                    <div
                        ...
                        <div class="flex items-start mb-4">
                            ...
                            <div class="ml-4">
                                <h3 class="text-lg font-semibold text-gray-900 mb-2">What are your operating hours?
                                </h3>
                    ...
                    <div
                        ...
                        <div class="flex items-start mb-4">
                            ...
                            <div class="ml-4">
                                <h3 class="text-lg font-semibold text-gray-900 mb-2">Do you accept walk-in patients?
                                </h3>
                                <p class="text-gray-600 font-light">
                    ...
                    <div
                        ...
                        <div class="flex items-start mb-4">
                            ...
                            <div class="ml-4">
                                <h3 class="text-lg font-semibold text-gray-900 mb-2">What payment methods do you
                                    accept?</h3>
                                <p class="text-gray-600 font-light">
                    ...
                    <div
                        ...
                        <div class="flex items-start mb-4">
                            ...
                            <div class="ml-4">
                                <h3 class="text-lg font-semibold text-gray-900 mb-2">How do I schedule an appointment?
                                </h3>
                                <p class="text-gray-600 font-light">
