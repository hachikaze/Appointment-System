...
<body class="bg-gray-100 overflow-x-hidden">
    ...
    <header class="fixed top-0 left-0 right-0 bg-white shadow z-40 px-4 py-3 flex items-center justify-between md:flex lg:hidden sm:flex">
        <div class="flex items-center space-x-3">
            <img src="/Images/doctor1.jpg" alt="User Avatar" class="h-9 w-9 rounded-full object-cover border-2 border-blue-200" />
            <div>
                <span class="block text-gray-800 font-medium text-sm">John Doe</span>
                <span class="block text-gray-500 text-xs">Administrator</span>
            </div>
        </div>
        <button type="button" 
                id="burger-button" 
                class="text-gray-600 p-2 rounded hover:bg-gray-100 hover:text-gray-800 transition md:block lg:hidden sm:block">
    ...
    <aside id="sidebar" 
        ...
        <!-- Logo & Profile -->
        <div class="flex flex-col items-center border-b px-4 py-6">
            <div class="mb-4">
                <img src="/Images/logo.png" alt="Clinic Logo" class="h-16 object-contain" />
            </div>
            <img src="/Images/doctor1.jpg" alt="Admin Avatar" class="h-24 w-24 rounded-full object-cover border-4 border-blue-100 shadow" />
            ...
            <a href="{{ route('admin.dashboard') }}" 
               class="flex items-center p-3 rounded-lg hover:bg-blue-50 hover:text-blue-600 text-gray-600 mb-1 
                      @if (request()->is('dashboard')) bg-blue-50 text-blue-600 font-medium @endif">
            ...
            <a href="{{ route('appointments.index') }}" 
               class="flex items-center p-3 rounded-lg hover:bg-blue-50 hover:text-blue-600 text-gray-600 mb-1 
                      @if (request()->is('appointments')) bg-blue-50 text-blue-600 font-medium @endif">
                <svg class="w-6 h-6 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
            ...
            class="flex items-center p-3 rounded-lg hover:bg-blue-50 hover:text-blue-600 text-gray-600 mb-1
            @if (request()->routeIs('admin.appointments.create')) bg-blue-50 text-blue-600 font-medium @endif">
                <svg class="w-6 h-6 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            class="flex items-center p-3 rounded-lg hover:bg-blue-50 hover:text-blue-600 text-gray-600 mb-1
            @if (request()->routeIs('admin.calendar')) bg-blue-50 text-blue-600 font-medium @endif">
                <svg class="w-6 h-6 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <!-- Patient Records -->
            <a href="#" class="flex items-center p-3 rounded-lg hover:bg-blue-50 hover:text-blue-600 text-gray-600 mb-1">
                <svg class="w-6 h-6 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
            ...
            <div x-data="{ open: false }" class="mb-1">
                <button @click="open = !open" 
                        class="w-full flex items-center p-3 rounded-lg hover:bg-blue-50 hover:text-blue-600 text-gray-600 transition">
                    <svg class="w-6 h-6 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                ...
                <div x-show="open" x-transition class="mt-1 ml-8 space-y-1 bg-white rounded">
                    <a href="#" class="flex items-center px-4 py-2 text-sm text-gray-600 hover:bg-blue-50 hover:text-blue-600 rounded-lg">
            ...
            <!-- Users -->
            <a href="{{ route('admin.users') }}" class="flex items-center p-3 rounded-lg hover:bg-blue-50 hover:text-blue-600 text-gray-600 mb-1">
                <svg class="w-6 h-6 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
        ...
        <div class="fixed inset-0 flex items-center justify-center px-4 py-6">
            <div class="bg-white rounded-xl shadow-lg max-w-md w-full overflow-hidden">
                ...
                <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse">
                    <button type="button"
                            class="w-full inline-flex justify-center rounded-xl bg-red-600 px-4 py-2 text-sm font-medium text-white hover:bg-red-500 sm:ml-3 sm:w-auto"
    ...
    <div class="fixed bottom-0 right-0 bg-black text-white p-2 text-sm z-50">
