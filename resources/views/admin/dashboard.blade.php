<x-sidebar-layout>
    ...
    <div class="p-6 bg-gray-50 min-h-screen">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-8">
            <!-- Admin Stats -->
            <div class="bg-gradient-to-br from-purple-500 to-indigo-600 rounded-2xl p-6 text-white shadow-lg transform hover:scale-105 transition-transform duration-200">
            ...
            <!-- Patient Stats -->
            <div class="bg-gradient-to-br from-emerald-500 to-teal-600 rounded-2xl p-6 text-white shadow-lg transform hover:scale-105 transition-transform duration-200">
                <div class="flex justify-between items-start">
                    <div>
            ...
            <div class="bg-gradient-to-br from-blue-500 to-cyan-600 rounded-2xl p-6 text-white shadow-lg transform hover:scale-105 transition-transform duration-200">
                <div class="flex justify-between items-start">
                    <div>
                    ...
                    <div class="bg-white/20 p-3 rounded-xl">
                        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
                            <path d="M8 2a1 1 0 011 1v1h2V3a1 1 0 112 0v1h1a2 2 0 012 2v1h-9V6a2 2 0 012-2h1V3a1 1 0 011-1zm9 6v10a2 2 0 01-2 2H5a2 2 0 01-2-2V8h14z"></path>
                        </svg>
                    </div>
                </div>
                <div class="mt-4 text-white/80 text-sm">
            ...
            <!-- Monthly Stats -->
            <div class="bg-gradient-to-br from-amber-500 to-orange-600 rounded-2xl p-6 text-white shadow-lg transform hover:scale-105 transition-transform duration-200">
                <div class="flex justify-between items-start">
                    <div>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <div class="flex space-x-2">
                        <select id="monthSelect" class="bg-purple-50 text-purple-600 px-3 py-1 rounded-full text-sm font-medium border-none focus:ring-2 focus:ring-purple-200">
        ...
        <div class="mt-8 bg-white rounded-2xl shadow-lg p-6">
            <div class="flex items-center justify-between mb-6">
                ...
                <div class="flex space-x-2">
                    <button class="bg-gray-100 text-gray-600 px-3 py-1 rounded-full text-sm font-medium hover:bg-gray-200 transition-colors duration-200">
                        Today
                    </button>
                    <button class="bg-blue-50 text-blue-600 px-3 py-1 rounded-full text-sm font-medium hover:bg-blue-100 transition-colors duration-200">
                        View All
                    </button>
                </div>
            </div>
