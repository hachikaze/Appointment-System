...
<x-patientnav-layout>
                ...
                <div class="flex grid-cols-2 justify-between">
                    <div class="space-y-3 text-gray-600">
                        ...
                        <ul class="list-disc ml-5 space-y-2">
                            ...
                            <li>If an approved appointment is not attended, it will be marked as unattended.</li>
                        ...
                        <div class="mt-4 flex items-center">
                            <p class="text-sm bg-teal-100 rounded-lg p-2">
                                ...
                                Ensure you attend or manage your appointments promptly to avoid scheduling conflicts.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="bg-teal-100 border-teal-500 border-b-4 border-l-2 border-r-2 rounded-lg shadow-lg">
                        ...
                        <div class="p-2 space-y-5">
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <span class="text-sm text-gray-700"><span
                                        class="font-bold text-gray-500">Unattended</span> - The participant was expected
                                    but did
                                    not attend.</span>
                            </div>
                            <div class="flex items-center space-x-2">
                                ...
                                <span class="text-sm text-gray-700"><span
                                        class="font-bold text-orange-500">Pending</span> - Attendance status is not yet
                                    confirmed.</span>
                            </div>
                            <div class="flex items-center space-x-2">
                                <div class="w-4 h-4 bg-red-500 rounded"></div>
                                <span class="text-sm text-gray-700"><span
                                        class="font-bold text-red-500">Cancelled</span>- The event or attendance was
                                    canceled.</span>
                            </div>
                            <div class="flex items-center space-x-2">
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            const availableAppointments = @json($availableappointments);
            ...
            function renderCalendar(month, year) {
                ...
                `;
                    ...
                    for (let day = 1; day <= daysInMonth; day++) {
                        ...
                        // Find available time slots for the current date
                        const availableSlots = availableAppointments.filter(app => app.date === dateString);

                        // Default values
                        let bgColor = "bg-white";
                        let borderColor = "border-teal-500";
                        let textColor = "text-teal-700";
                        let tooltipText = "No appointment";
                        ...
                        daySlot.className = `hidden sm:flex flex-col items-center justify-center shadow-lg border-l-4 rounded-lg text-xl font-semibold transition-all duration-300 hover:bg-teal-100 hover:text-gray-700 cursor-pointer shadow-md w-full h-16 sm:h-20 md:h-18 lg:h-28 xl:h-24 2xl:h-28 ${bgColor} ${borderColor} ${textColor}`;
                        daySlot.title = tooltipText;

                        // Add the day number inside the slot
                        const dayNumber = document.createElement('span');
                        ...
                        if (availableSlots.length > 0) {
                            availableSlots.forEach(slot => {
                                totalSlots += slot.remaining_slots;
                            });

                            // Add total slots
                            const totalSlotsInfo = document.createElement('span');
                            totalSlotsInfo.className = "font-bold text-teal-600";
                            totalSlotsInfo.innerText = `Total Slots: ${totalSlots}`;
                            slotsContainer.appendChild(totalSlotsInfo);
                        } else {
                        ...
                        // Append elements to the day slot
                        daySlot.appendChild(dayNumber);
                        daySlot.appendChild(slotsContainer);
