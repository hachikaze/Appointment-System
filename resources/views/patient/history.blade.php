                            ...
                            <tbody class="text-lg">
                                @foreach ($appointments as $appointment)
                                    <tr class="bg-white border-b  border-gray-200">
                                        ...
                                        <td class="px-6 py-4">
                                            {{ Carbon::parse($appointment->time)->format('F j, Y') }}
                                        </td>
                                        <td class="px-6 py-4">
                                            @php
                                                $statusClass = match ($appointment->status) {
                                                    ...
                                                    'Mark as Attended' => 'bg-blue-100 text-blue-700 border-blue-500',
                                                    default => 'bg-gray-100 text-gray-700 border-gray-500',
                                                };
                                            @endphp

                                            <span
                                                class="p-4  py-3 text-sm font-medium border rounded-lg {{ $statusClass }}">
                                                {{ $appointment->status }}
                                            </span>
                                        </td>
                                        ...
                                        <td class="px-6 py-4 text-center">
                                            <button onclick="openModal()"
                                                class="bg-blue-500 font-medium text-white p-2 rounded-lg px-6 shadow-lg hover:underline">
                                        ...
                                        <div id="modal"
                                            ...
                                            <div
                                                ...
                                                <p class="text-gray-700 text-md mb-2"><strong>Phone Number:</strong>
                                                    {{ $appointment->phone }}</p>
                                                <p class="text-gray-700 text-md mb-2"><strong>Reason:</strong>
                                                ...
                                                <p class="text-gray-700 text-md mb-2"><strong>Time:</strong>
                                                    {{ \Carbon\Carbon::parse($appointment->time)->format('h:i A') }}
                                                </p>
                                                <p class="text-gray-700 text-md mb-4"><strong>Status:</strong>
                                                    <span
                                                        class="px-3 py-1 text-sm font-medium border rounded-lg
                                                @if ($appointment->status == 'Approved') bg-green-100 text-green-700 border-green-500
                                                @elseif ($appointment->status == 'Cancelled') bg-red-100 text-red-700 border-red-500
                                                @elseif ($appointment->status == 'Attended') bg-blue-100 text-blue-700 border-blue-500
                                                @else bg-gray-100 text-gray-700 border-gray-500 @endif">
                                                        {{ $appointment->status }}
                                                    </span>
                                                </p>
                                                ...
                                                <label for="notes"
                                                    ...
                                                    Notes:</label>
                                                <textarea id="notes" name="notes" rows="6" class="w-full border border-teal-500 rounded-md shadow-sm p-2 "
