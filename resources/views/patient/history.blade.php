                                                                    ...
                                                                    <td class="px-6 py-4 text-center">
                                                                        ...
                                                                        @if(in_array($appointment->status, ['Cancelled', 'Unattended']))
                                                                            <button onclick="window.location.href='{{ route('calendar') }}'"
                                                                                class="bg-yellow-500 font-medium text-white p-2 rounded-lg px-6 shadow-lg hover:bg-yellow-600 transition ml-2">
                                                                        ...
                                                                        @if(in_array($appointment->status, ['Approved', 'Pending']))
                                                                            <button data-modal-target="update-appointment-modal"
                                                                                ...
                                                                                class="bg-red-500 font-medium text-white p-2 rounded-lg px-6 shadow-lg hover:bg-red-600 transition ml-2">
                                                                    ...
                                                                    <div id="modal"
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div class="flex flex-col gap-4 p-6">
                                                                                <p class="text-gray-700 text-md"><strong>Patient Name:</strong> <span
                                                                                        id="patientName">Loading...</span></p>
                                                                                <p class="text-gray-700 text-md"><strong>Phone Number:</strong> <span
                                                                                        id="phoneNumber">Loading...</span></p>
                                                                            ...
                                                                            <div class="p-6 pt-0 flex flex-wrap gap-2 justify-center sm:justify-end">
