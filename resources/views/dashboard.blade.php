    ...
    <x-audit-modal modalid="auditModal" title="Audit Log">
        <div class="overflow-x-auto shadow-lg rounded-lg border-teal-500 border-2">
            <div class="flex justify-between items-center p-4 bg-white border-b border-gray-300">
                ...
                <form method="GET" action="{{ url()->current() }}" class="searchform flex space-x-2">
            ...
            <div class="py-12">
                <div class="max-w-8xl mx-auto px-6 lg:px-8  lg:gap-8 gap-4 xl:grid grid-cols-4 lg:grid grid-cols-1   ">
                    ...
                    <div
                        ...
                        <div class="flex flex-col bg-teal-50 rounded-b-lg  border-b-4 border-teal-500 items-center p-2">
                            <div class="relative m-4">
                                <div
                                    class="absolute inset-0 bg-gradient-to-r from-teal-400  to-emerald-400 rounded-full p-1">
                                </div>
                                <div
                            ...
                            <div class="relative rounded-lg border-l-4 border-teal-500 h-96 overflow-y-auto m-1 pl-6">
                                @foreach ($auditTrails as $audit)
                                    <div class="relative mb-6">
                                        ...
                                        <div
                                            class="bg-teal-50 border-l-4 border-teal-400  shadow-md rounded-lg mr-2 p-4 ml-4">
                        ...
                        <div class="p-5 pt-0">
                            <button onclick="openModal('auditModal')"
                                class="bg-teal-500 text-white px-4 py-2 rounded-lg w-full transform hover:scale-105 transition-transform duration-200">
                        ...
                        <div class="relative flex flex-col rounded-xl bg-white bg-clip-border text-gray-700 ">
                            <div
                                ...
                                <div class="bg-teal-100 w-full shadow-lg rounded-lg p-2 border-b-4 border-teal-600">
                                    ...
                                    <p
                                        class="block max-w-sm text-sm font-normal leading-normal text-gray-700 antialiased">
                            ...
                            <div class="py-6 mt-4 grid place-items-center px-2">
                                <div
                                    class="flex items-center justify-start gap-2 text-xl font-semibold text-teal-600 mx-2">
                    ...
                    <div
                        ...
                        <div
                            class="bg-white p-6 rounded-lg  max-w-xxl mx-auto flex flex-col items-center justify-center ">
                            <div class="relative size-72 items-center justify-center">
                                <svg class="size-full rotate-180" viewBox="0 0 36 36"
                                    ...
                                    <circle cx="18" cy="18" r="16" fill="none"
                                        ...
                                        stroke-dasharray="{{ ($attendanceRate / 100) * 50 }}, 100"
                            ...
                            <div class="space-y-4">
                                ...
                                <div
                                    ...
                                    <p><strong>Address:</strong> H2PR+X34, Nueve de Febrero, Mandaluyong, Kalakhang
                                        Maynila</p>
                                </div>
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div
                                    class="bg-teal-200 p-4 rounded-t-lg rounded-b-lg border-b-4 border-teal-600 w-full">
                    ...
                    if (searchForm) {
                        searchForm.addEventListener("submit", function(event) {
                            ...
                            if (searchInput) {
                                ...
                                let formAction = new URL(searchForm.action, window.location
                                    .origin);

                                if (searchValue) {
                                    formAction.searchParams.set("search", searchValue);
                                    formAction.searchParams.set("auditModal",
                                        "true");
                                } else {
                                    formAction.searchParams.delete("search");
                                }
                ...
                function closeAuditModal(modalId) {
                    fetch("{{ route('close.audit.modal') }}", {
                        ...
                        .then(data => {
                            ...
                            closeModal(modalId);
                            removeQueryParams(["auditModal"]); // Remove auditModal but keep search
                        })
